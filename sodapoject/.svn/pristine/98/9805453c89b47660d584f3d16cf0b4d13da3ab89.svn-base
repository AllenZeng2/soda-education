  ...
  <tr>
    ...
    <div style="overflow:auto;height:100%; width:100%">
      ...
      <div style="width:100%; text-align:center; padding:5px">
      	<BUTTON style="HEIGHT:25px" onClick="javascript:location.href='../stu/list.jsp';" name="submit" ><img src="../../images/btn_search.gif" width="16" height="16" align="absmiddle"> 学生信息</BUTTON>
