    ...
    <td style="height:34px; background-image:url(../../images/main_header.gif); border-bottom:1px solid #cfd8e0; padding:0px">
      <table width="100%" border="0" cellspacing="0" cellpadding="0" name="listTable2">
        <tr>
          ...
          <td style="color:#90c8e8;"><img src="../../images/icon_card.gif" width="16" height="16" align="absmiddle">&nbsp;&nbsp;<strong>课程管理</strong></td>
  ...
  <tr>
    <td style="height:30px; background-color:#bddbff; border-bottom:1px solid #cfd8e0;"><table width="100%" border="0" cellpadding="3" cellspacing="1" class="table1" name="listTable3">
      <TR>
        ...
        <td width="20%" class="BGCgray"><input type="text" name="ce_name" id="textfield"></td>
    ...
    <div style="overflow:auto;height:100%; width:100%">
      <table width="100%" border="0" cellpadding="3" cellspacing="1" class="table1" name="listTable4">
        ...
        <TR>
          ...
          <TD align="center">java se</TD>
          <TD align="center">北京联合大学</TD>
          <TD align="center">现场课程</TD>
          <TD align="center">可报名</TD>
          <TD align="center">李素</TD>
          <TD align="center">2000</TD>
          <TD width="200" align="center"><BUTTON style="height:21px; font-size:12px" onClick="javascript:location.href='detail.jsp'">查看</BUTTON> <BUTTON style="height:21px; font-size:12px" onClick="javascript:location.href='edit.jsp'">编辑</BUTTON><BUTTON style="height:21px; font-size:12px" onClick="">结课</BUTTON></TD>
        </TR>
        <TR>
          <TD align="center"><input type="checkbox" name="checkbox2" id="checkbox2"></TD>
          <TD align="center">java se</TD>
        ...
        <TR>
          ...
          <TD align="center">北京联合大学</TD>
          <TD align="center">现场课程</TD>
          <TD align="center">报名已结束</TD>
          <TD align="center">李素</TD>
          <TD align="center">2000</TD>
          <TD width="200" align="center"><BUTTON style="height:21px; font-size:12px" onClick="javascript:location.href='detail.jsp'">查看</BUTTON> <BUTTON style="height:21px; font-size:12px" onClick="javascript:location.href='edit.jsp'">编辑</BUTTON>
          </TD>
        </TR>
        <TR>
          <TD align="center"><input type="checkbox" name="checkbox2" id="checkbox2"></TD>
          <TD align="center">java se</TD>
          <TD align="center">北京联合大学</TD>
          <TD align="center">在线课程</TD>
          <TD align="center">可购买</TD>
          <TD align="center">李素</TD>
          <TD align="center">2000</TD>
          <TD width="200" align="center"><BUTTON style="height:21px; font-size:12px" onClick="javascript:location.href='detail.jsp'">查看</BUTTON> <BUTTON style="height:21px; font-size:12px" onClick="javascript:location.href='edit.jsp'">编辑</BUTTON><BUTTON style="height:21px; font-size:12px" onClick="">下架</BUTTON></TD>
        </TR>
        <TR>
          <TD align="center"><input type="checkbox" name="checkbox2" id="checkbox2"></TD>
          <TD align="center">java se</TD>
