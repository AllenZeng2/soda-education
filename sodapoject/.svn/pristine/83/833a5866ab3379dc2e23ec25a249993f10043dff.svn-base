...
<body>
<table width="100%" height="100%" border="0" cellspacing="0" cellpadding="3" name="mycourseTable">
  <tr>
  ...
  <tr>
    <td style="height:34px; background-image:url(../../images/main_header.gif); border-bottom:1px solid #cfd8e0; padding:0px">
      <table width="100%" border="0" cellspacing="0" cellpadding="0" name="mycourseTable2">
        <tr>
          ...
          <td align="right" class="white" style="padding-right:20px"><a href="add.jsp" class="barBtn" onClick="location.href='add.jsp'" name="add"><img src="../../images/5.png" align="absmiddle"> 新增</a> <a href="#" class="barBtn" onClick="javascript:history.go(-1);" name="retreat"><img src="../../images/btn_left.gif" align="absmiddle"> 后退</a> <a href="#" class="barBtn" onClick="javascript:history.go(+1);" name="advance"><img src="../../images/btn_right.gif" align="absmiddle"> 前进</a> <a href="#" class="barBtn" name="flush" ><img src="../../images/btn_refresh.gif" align="absmiddle"> 刷新</a>
  ...
  <tr>
    <td style="height:30px; background-color:#bddbff; border-bottom:1px solid #cfd8e0;"><table width="100%" border="0" cellpadding="3" cellspacing="1" class="table1" name="mycourseTable3">
      <TR>
  ...
  <tr>
    ...
    <div style="overflow:auto;height:100%; width:100%">
      <table width="100%" border="0" cellpadding="3" cellspacing="1" class="table1" name="mycourseTable4">
        <TR>
        ...
        <TR>
          ...
          <TD width="200" align="center"><BUTTON style="height:21px; font-size:12px" onClick="javascript:location.href='detail.jsp'">查看</BUTTON> <BUTTON style="height:21px; font-size:12px" onClick="javascript:location.href='edit.jsp'">编辑</BUTTON> <BUTTON style="height:21px; font-size:12px" onClick="javascript:if (confirm('是否禁用？')) location.href='#';else return;">禁用</BUTTON> <BUTTON style="height:21px; font-size:12px" onClick="javascript:if (confirm('是否删除？')) location.href='#';else return;">删除</BUTTON></TD>
        </TR>
        <TR>
          <TD align="center"><input type="checkbox" name="checkbox2" id="checkbox2"></TD>
          <TD align="center">张三</TD>
      ...
      <table width="100%" border="0" cellspacing="0" cellpadding="0" name="mycourseTable5">
        <tr>
          <td width="20%" height="25"><table border="0" cellspacing="0" cellpadding="3">
            <tr>
              <td><a href="#" name="pageFirst"><img src="../../images/prev_top.gif" width="16" height="16" border="0"></a></td>
              <td><a href="#" name="pageUp"><img src="../../images/prev.gif" width="16" height="16" border="0"></a></td>
              <td><a href="#" name="pageNext"><img src="../../images/next.gif" width="16" height="16" border="0"></a></td>
              <td><a href="#" name="pageEnd"><img src="../../images/prev_end.gif" width="16" height="16" border="0"></a></td>
            </tr>
          </table></td>
          <td width="20%" align="center"><table border="0" cellspacing="0" cellpadding="3" name="mycourseTable6">
            <tr>
