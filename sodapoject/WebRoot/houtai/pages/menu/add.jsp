...
<script type="text/javascript">
  ...
  //判断名字是否重复
	...
	function ckname(value){
		//var vname=document.getElementById("menuName").value;
    ...
    <div style="overflow:auto;height:100%; width:100%">
      <table width="100%" border="0" cellpadding="3" cellspacing="1" class="table1" name="addTable3" >
        <TR>
          ...
          <TD class="BGCgray"><input type="text" id="menuName" name="mu_name" onblur="ckname(value)"/>
        ...
        <TR>
          ...
          <TD class="BGCgray">
             ...
             <c:forEach items="${menus }" var="m">
             	<option	value="${m.fmen_id }">${m.fme_name }</option>
             </c:forEach>
