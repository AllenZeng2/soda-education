...
<table width="100%" height="100%" border="0" cellspacing="0" cellpadding="3" name="lookTable">
  ...
  <tr>
    <td style="height:30px; background-color:#bddbff; border-bottom:1px solid #cfd8e0;"><table width="100%" border="0" cellpadding="3" cellspacing="1" class="table1" name="lookTable3">
      <TR>
        <th width="10%" align="center">评价内容</th>
        <td width="20%" class="BGCgray"><input type="text" name="ns_content" id="textfield"></td>
        <th width="10%" align="center">评价时间</th>
        <td width="20%" class="BGCgray"><input type="text" name="ns_showtime" id="textfield"></td>
        <th width="10%" align="center"><BUTTON   style="HEIGHT:25px" onClick="javascript:if (confirm('查询数据？')) location.href='#';else return;" name="dimSelect"><img src="../../images/btn_search.gif" width="16" height="16" align="absmiddle"> 查询</BUTTON></th>
        </TR>
    </table></td>
  </tr>
  <tr>
    ...
    <div style="overflow:auto;height:100%; width:100%">
      <table width="100%" border="0" cellpadding="3" cellspacing="1" class="table1" name="lookTable4">
        <TR>
          <th align="center"><input type="checkbox" name="checkbox1" id="checkbox1" onChange="allCheck()"></th>
      ...
      <table width="100%" border="0" cellspacing="0" cellpadding="0" name="lookTable5">
        <tr>
          ...
          <td width="20%" align="center"><table border="0" cellspacing="0" cellpadding="3" name="lookTable6">
            <tr>
