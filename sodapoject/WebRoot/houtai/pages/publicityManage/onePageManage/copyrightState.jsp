				...
				<table width="100%" border="0" cellspacing="0" cellpadding="0"
					...
					<tr>
						...
						<td style="color: #90c8e8;"><img
							...
							align="absmiddle">&nbsp;&nbsp; <strong>版权声明</strong></td>
					</tr>
				</table>
			</td>
		</tr>
		<tr>
			<td height="100%" valign="top">
				<div style="overflow: auto; height: 100%; width: 100%">
					<form action="CopyrightStateServlet?gansha=update" method="post" name="surveyForm" onsubmit="return check()" >
						<table width="100%" border="0" cellpadding="3" cellspacing="1"
							class="table1" name="surveyTable3">
							<tr>
								<td style="text-align: right">标题</td>
								<td>${copyrightState.sy_title }</td>
							</tr>
							<tr>
								<td style="text-align: right">作者</td>
								<td>${copyrightState.sy_other1 }</td>
							</tr>
							<tr>
								<td style="text-align: right">内容</td>
								<td><textarea rows="15" cols="52" name="sy_content" id="sy_content" >${copyrightState.sy_content}</textarea></td>
							</tr>
							<tr>
