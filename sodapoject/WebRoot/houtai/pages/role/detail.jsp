    ...
    <td style="height:34px; background-image:url(houtai/images/main_header.gif); border-bottom:1px solid #cfd8e0; padding:0px">
      <table width="100%" border="0" cellspacing="0" cellpadding="0" name="detailTable2">
        <tr>
          ...
          <td style="color:#90c8e8;"><img src="houtai/images/icon_card.gif" width="16" height="16" align="absmiddle">&nbsp;&nbsp;<strong>角色信息</strong></td>
          ...
          <a href="Javascript:location.reload();" class="flush" name="homePageFlush"><img src="houtai/images/btn_refresh.gif" align="absmiddle"> 刷新</a>
          </td>
        </tr>
    </table></td>
  </tr>
    ...
    <div style="overflow:auto;height:100%; width:100%">
      <table width="100%" border="0" cellpadding="3" cellspacing="1" class="table1" name="detailTable3">
        <TR>
          ...
          <TD class="BGCgray">${role.re_name }</TD>
        </TR>
       <TR>
          ...
          <TD class="BGCgray">
			...
			<c:forEach items="${role.fmenu }" var="fm">
            	<li><input type="checkbox"/>${fm.fme_name }
                	<ul>
		
					
					<c:forEach items="${fm.menu }" var="menu">
						<li><input type="checkbox" value=""/>${menu.mu_name }</li>
					</c:forEach>
