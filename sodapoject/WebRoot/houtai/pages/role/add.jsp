    ...
    <div style="overflow:auto;height:100%; width:100%">
      <table width="100%" border="0" cellpadding="3" cellspacing="1" class="table1" name="addTable3" >
        <TR>
          ...
          <TD class="BGCgray">
          <input id="roler" 
          type="text" name="ro_name"  onblur="ckname(value)"/>
...
<!-- 			
 ...
 -->
      ...
      <div style="width:100%; text-align:center; padding:5px">
        ...
        <BUTTON style="HEIGHT:25px" onClick="javascript:if (confirm('您填写的信息还未保存，确认返回么？')) history.go(-1);return false;" 
