    ...
    <div style="overflow:auto;height:100%; width:100%">
      <table width="100%" border="0" cellpadding="3" cellspacing="1" class="table1" name="editTable3">
        <TR>
          ...
          <TD class="BGCgray"><input type="text" value="java se" name="ce_name"/></TD>
          </TR>
        <TR>
          <th align="center">上课地点</th>
          <TD width="80%" class="BGCgray">
          	<input type="text" value="北京大学" name="ce_adress"/>
          </TD>
         </TR>
      	<TR>
        ...
        <TR>
          ...
          <TD class="BGCgray">
          	<input type="text" value="2000" name="ce_money"/>
          </TD>
        </TR>
        <TR>
      ...
      <div style="width:100%; text-align:center; padding:5px">
        <BUTTON style="HEIGHT:25px" onClick="javascript:if (confirm('保存信息？')) location.href='list.jsp';else return;" name="sbumit"><img src="../../images/btn_save.gif" width="16" height="16" align="absmiddle" > 保存</BUTTON>
