    ...
    <div style="overflow:auto;height:100%; width:100%">
      <table width="100%" border="0" cellpadding="3" cellspacing="1" class="table1" name="detailTable3">
        <TR>
          ...
          <TD class="BGCgray">${user.ur_loginName }</TD>
        </TR>
        <TR>
      ...
      <div style="width:100%; text-align:center; padding:5px">
      	<BUTTON style="HEIGHT:25px" onClick="javascript:edit(${user.ur_id}); return false;"
      	 name="update"><img src="houtai/images/btn_back.gif" width="16" height="16" align="absmiddle"> 修改</BUTTON>
