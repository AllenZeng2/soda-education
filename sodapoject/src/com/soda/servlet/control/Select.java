...
public class Select {
	...
	public void selectUsers(HttpServletRequest request,
			HttpServletResponse response) throws ServletException, IOException {
		request.setCharacterEncoding("utf-8");

		// String(request.getParameter("loginName").getBytes("ISO-8859-1"),"utf-8");
		String loginName = request.getParameter("ur_loginName");
		// String realName=new
		// String(request.getParameter("realName").getBytes("ISO-8859-1"),"utf-8");
		String realName = request.getParameter("ur_name2");
		// String state=new
		// String(request.getParameter("state").getBytes("ISO-8859-1"),"utf-8");
